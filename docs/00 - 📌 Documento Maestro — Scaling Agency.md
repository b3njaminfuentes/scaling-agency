---
title: "📌 LIGHT PARTNERS — Documento Maestro"
aliases:
  - "Documento Maestro"
  - "Master Blueprint"
tags:
...
created: 2026-08-03
version: "1.1.0"
brand: "LIGHT PARTNERS — Growth Partners for Clinics"
founders:
  - "Benjamin Fuentes (Tech & Systems)"
  - "Hermano Fuentes (Media Buyer & Sales)"
niche: "Clínicas Dentales & Centros Médicos"
---
...
```mermaid
graph TD
    A["📌 00 - Documento Maestro"] --> B["💎 01 - Oferta & Mecanismo Único"]
    A --> C["🎯 02 - Caso de Éxito: Paciente Cero"]
    A --> D["👥 03 - Roles, SOPs & Operaciones"]
    A --> E["🚀 04 - Plan de Ataque: Primeros 30 Días"]
    A --> F["🌐 05 - Wireframe & Copy de Landing"]
    
    B --> G["Adquisición Predecible de Pacientes"]
    C --> H["Caso Clínica Villarroel (+65 Pacientes/sem)"]
    D --> I["División Benja (Tech) & Hermano (Ads/Ventas)"]
```
...
```mermaid
flowchart LR
    A["Meta Ads"] --> B["Landing Propia"]
    B --> C["WhatsApp Lead Tracking"]
    C --> D["Agenda Confirmada"]
    D --> E["Paciente en Box"]
```
...
```mermaid
flowchart LR
    subgraph Hermano["🧑‍💻 Hermano (Head of Growth & Ads)"]
        H1["Meta Ads (CBO/ABO, Audiencias)"]
        H2["Creativos & Hooks Visuales"]
        H3["Relación con el Cliente & Ventas"]
    end

    subgraph Benja["⚡ Benja (Head of Tech & Systems)"]
        B1["Landing Pages de Alta Conversión"]
        B2["Automatizaciones & CRM (Make/n8n/Supabase)"]
        B3["Dashboards de Métricas en Vivo"]
        B4["Agentes de IA para Calificación Rápida"]
    end
```
